...
// Where [Project] hard-codes its (ActivityPub/ActivityStreams style) JSON-LD type, AnyProject allows anything to be loaded — including multple values, and sub-types.
