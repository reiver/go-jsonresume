...
// Where [Award] hard-codes its (ActivityPub/ActivityStreams style) JSON-LD type, AnyAward allows anything to be loaded — including multple values, and sub-types.
