...
// AnyAward is similar to [Award] except that it is less restrictive about the (ActivityPub/ActivityStreams style) JSON-LD type.
// Where [Award] hard-codes its (ActivityPub/ActivityStreams style) JSON-LD type, AnyAward allows anything to be loaded — including multiple values, and sub-types.
