...
// Where [Interest] hard-codes its (ActivityPub/ActivityStreams style) JSON-LD type, AnyInterest allows anything to be loaded — including multiple values, and sub-types.
