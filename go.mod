module github.com/reiver/go-jsonresume

go 1.26.1

require (
	codeberg.org/reiver/go-activitypub v0.0.0-20260526195958-c3ae1060dc7c
	...
	github.com/reiver/go-jsonld v0.0.0-20260526195905-2d71d7d7decf
