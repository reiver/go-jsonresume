...
// Where [Publication] hard-codes its (ActivityPub/ActivityStreams style) JSON-LD type, AnyPublication allows anything to be loaded — including multiple values, and sub-types.
