...
// Where [Language] hard-codes its (ActivityPub/ActivityStreams style) JSON-LD type, AnyLanguage allows anything to be loaded — including multple values, and sub-types.
