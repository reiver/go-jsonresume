...
// Where [Resume] hard-codes its (ActivityPub/ActivityStreams style) JSON-LD type, AnyResume allows anything to be loaded — including multiple values, and sub-types.
