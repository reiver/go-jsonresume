...
type PublicationID jsonld.ID

func SomePublicationID(value string) PublicationID {
	return PublicationID(jsonld.SomeID(value))
}

func (receiver PublicationID) MarshalJSON() ([]byte, error) {
