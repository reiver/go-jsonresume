...
// Where [Education] hard-codes its (ActivityPub/ActivityStreams style) JSON-LD type, AnyEducation allows anything to be loaded — including multple values, and sub-types.
